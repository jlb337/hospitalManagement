...
<div id="toolbar">
		...
		<button id="btn_add" class="btn btn-success">新增菜单信息</button>
...
// 		})
		...
		$("#open").click(function(){
    		if($("#addas").attr("class")=="showQuery"){
    			$("#addas").attr("class","hideQuery");
    			$("#addas").slideDown("fast");
    		}
    		else{
    			$("#addas").attr("class","showQuery");
    			$("#addas").slideUp("fast");
    		}
    	})
    	...
    	$("#tb_user").bootstrapTable({
    		url:"${pageContext.request.contextPath}/menu?method=queryByCondition",//访问地址
    		method:"get",//请求的方式
    		toolbar:"#toolbar",//工具栏
    	...
    	<!--修改按钮事件-->
    	  $("#btn_update").click(function(){
    		    ...
    		    $.ajax({
    		    	type:"post",//请求方式
    		    	url:"${pageContext.request.contextPath}/menu?method=update",//请求后台的地址
		...
		$("#btn_query").click(function() {
	                ...
	                $.ajax({
	                     type: "post",
	                     url: "${pageContext.request.contextPath}/menu?method=queryByCondition",
...
function updateFun(userIds){
    	$.ajax({
    		type:"post",//请求方式 get,post
    		url:"${pageContext.request.contextPath}/menu?method=sendUpdate",//请求后台的地址
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">增加菜单信息</h4>
            </div>
            <div class="modal-body">
                   <div class="form-group">
					    <label for="inputEmail3" class="col-sm-2 control-label">菜单名称:</label>
					    <div class="col-sm-10">
					      <input type="text" name="menuName" class="form-control" id="menuNameAdd" placeholder="职位名称:">
					    </div>
				 </div>
